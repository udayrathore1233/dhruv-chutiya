...
function changeDirectionButton(directionChange) {
  if (directionChange === 'left' && direction.x === 0) {
    direction = { x: -1, y: 0 }; // Left
  } else if (directionChange === 'up' && direction.y === 0) {
    direction = { x: 0, y: -1 }; // Up
  } else if (directionChange === 'right' && direction.x === 0) {
    direction = { x: 1, y: 0 }; // Right
  } else if (directionChange === 'down' && direction.y === 0) {
...
document.getElementById('left').addEventListener('click', () => changeDirectionButton('left'));
document.getElementById('up').addEventListener('click', () => changeDirectionButton('up'));
document.getElementById('right').addEventListener('click', () => changeDirectionButton('right'));
document.getElementById('down').addEventListener('click', () => changeDirectionButton('down'));
